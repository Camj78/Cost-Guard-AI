...
5. Fails the build (`exit 1`) if any prompt's risk score exceeds the configured threshold.
...
The build is intentionally blocked. Lower your prompt risk score by addressing the **Top Risks** listed in the PR comment, then push again.
