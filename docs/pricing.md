...
- CostGuardAI Safety Score + explainability output
...
|---|:---:|:---:|:---:|
| CLI analysis | ✓ | ✓ | ✓ |
| CostGuardAI Safety Score (0–100) | ✓ | ✓ | ✓ |
...
One team member ships a prompt with a CostGuardAI Safety Score below the team's
threshold because that threshold was never aligned across the team.
...
- **Unsafe production prompts** — CostGuardAI Safety Score below threshold blocks deployment
