...
/** Scoring specification version. Bump minor for term additions, major for weight/bucket changes. */
...
export interface RiskAssessment {
  ...
  isEstimated: boolean;
  /** Deterministic, rule-based explanation block. Always present. */
...
// --- Term lists (exported for ruleset_hash computation in CLI) ---
...
// --- Scoring weights (exported for ruleset_hash computation in CLI) ---
...
/** Compute per-request cost from token counts and model pricing. */
