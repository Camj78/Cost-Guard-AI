 ...
 *
 * Static, deterministic mapping of the five risk drivers to:
 *   - Human-readable description
 *   - Contributing factors (what the engine detected)
 *   - Base mitigation suggestions (fallback when no dynamic fixes exist)
 *
 * This catalog is the authoritative source for explanation text.
 * No generative AI — all strings are compile-time constants.
 */

/** Structured explanation block attached to every RiskAssessment. */
...
/** Per-driver static metadata used by explanation-builder. */
...
/**
 * Keyed by the exact driver name strings produced by assessRisk():
 *   "Length Risk", "Context Saturation Risk", "Ambiguity Risk",
 *   "Structural Risk", "Output Volatility Risk"
 */
